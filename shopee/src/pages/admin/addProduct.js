                ...
                <div className="row">
                    ...
                    <div className="col-10">
                        ...
                        <div className="row" style={{ marginTop: '5%' }}>
                            ...
                            <p className="col-12">
                                <button type="submit" onClick={this.addProduct} className="btn btn-block btn-primary" id="addProduct__button" disabled={addProductQueryStatus}> {addProductQueryStatus ? <img src={`../` + loader} width={20} /> : "Add Product"}</button>
                            </p>
