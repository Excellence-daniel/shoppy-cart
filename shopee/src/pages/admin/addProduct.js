...
export default class AddProducts extends Component {
  ...
  addProduct = async e => {
    ...
    if (
      ...
      try {
        const addProductQuery = await axios.post(
          `${server_database_url}/addProduct`,
          data
        );
            ...
            <div className="row" style={{ marginTop: "5%" }}>
              <p className="col-6" id="productName ">
                <TextInput
                  label={"Product Name"}
                  icon={"fas fa-search"}
                  function={this.handleProductName}
                />
              </p>
              ...
              >
                <SelectField
                  ...
                  categories={["Men", "Women", "Unisex", "FootWear"]}
                  value={this.state.productCategory}
                  function={this.handleProductCategorySelect}
                />
              </p>
              ...
              <p className="col-6" id="productPrice">
                <TextInput
                  ...
                  function={this.handleProductPrice}
                />
              </p>
                ...
                <p>
                  <div>
                    ...
                    <span
                      style={{
                        fontSize: "0.7rem",
                        color: "rgba(27, 121, 82, 0.61)"
                      }}
                    >
                      (*accepts only PNG and JPG*)
                    </span>
                  </div>
                </p>
              </p>
              ...
              <p className="col-12">
                <button
                  ...
                  id="addProduct__button"
                  disabled={addProductQueryStatus}
                >
                  {" "}
                  {addProductQueryStatus ? (
