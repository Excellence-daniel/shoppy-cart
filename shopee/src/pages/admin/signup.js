          ...
          <div style={{ marginTop: "10%" }}>
            ...
            <p className="email">
              <TextInput
                label={"Email Address"}
                icon={"fas fa-at"}
                function={this.handleEmailInput}
              />
            </p>
            ...
            <p className="password">
              <TextInput
                label={"Password"}
                icon={"fas fa-key"}
                function={this.handlePasswordInput}
              />
            </p>
            <p style={{ marginLeft: "3%" }}>
              <input
                ...
                id="exampleCheck1"
                onClick={this.agreeFunc}
              />
              <label class="form-check-label" for="exampleCheck1">
                I agree with all <Link>Terms and Conditions</Link>
              </label>
            </p>
            <p>
              <Button
